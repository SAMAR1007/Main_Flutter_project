...
router.post('/admin/:id/messages', verifyToken, isAdmin, addMessage);
router.get('/admin/:id', verifyToken, isAdmin, getConversation);
router.patch('/admin/:id/read', verifyToken, isAdmin, markRead);
